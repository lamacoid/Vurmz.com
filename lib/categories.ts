...
export const SHOP_CATEGORIES: ShopCategory[] = [
  ...
  },
  {
    ...
    description: `Bring your own item engraving in Centennial, CO. Knives, laptops, tumblers, flasks, tools, heirlooms: anything you bring, engraved. $${SIGNATURE.startingAt} flat within size. Hand-delivered by VURMZ.`,
    ...
    faqs: [
      ...
      { question: 'Will engraving hurt it?', answer: 'No. The mark is surface-level, it won\'t weaken a blade\'s edge or a laptop\'s shell. On a knife I test on the spine first. You approve a proof photo before I touch the real thing.' },
  ...
  },
  {
    ...
    cardDescription: 'Maps on mirrors, photos on slate, custom pieces on wood and metal. If you can send me an image, I can probably engrave it.',
