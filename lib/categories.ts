...
export const SHOP_CATEGORIES: ShopCategory[] = [
  {
    ...
    faqs: [
      ...
      { question: 'I know what I want but I do not have it.', answer: 'Happy to source. Name the piece and I find it, buy it, engrave it, and bring it to you. The piece is billed at its price plus $65 to find it, mark it, and bring it, and a deposit holds it.' },
      ...
      { question: 'Can I ask questions before it is made?', answer: 'Always. Text me a photo and what you have in mind and I will tell you exactly how it will look on that material.' },
    ],
    relatedCategories: ['bring-your-own', 'tumblers', 'decor'],
    howItWorks: [
      'Send a photo of the piece, or describe the gift and the occasion',
      'I send a number and the layout',
  ...
  },
  {
    ...
    howItWorks: [
      ...
      'Pay to hold the slot; I confirm anything extra before it runs',
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'I want a particular brand.', answer: 'Happy to source. Name it and I find it, engrave it, and bring it. The piece is billed at its price plus $65 to find it, mark it, and bring it.' },
    ],
  ...
  },
  {
    ...
    description: 'Engraved coasters in Centennial, Colorado. Natural slate, solid pine, brushed and gold stainless steel, in sets of four made to match. Hand-delivered across the south Denver metro.',
    ...
    faqs: [
      ...
      { question: 'For a restaurant, a bar, or an office?', answer: `Business sets start at ${CATALOG.coasters.pack} and are priced on the services side.` },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'For a wedding, a team, or a company?', answer: 'Yes. Sets made to match, every one from the same file.' },
    ],
    relatedCategories: ['coasters', 'gifts'],
    howItWorks: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Can you work from my own art or a photo?', answer: 'Yes. A drawing, a photograph, a sketch on a napkin. I prepare the file and we settle the layout together before it runs.' },
    ],
    relatedCategories: ['gifts', 'tumblers'],
    howItWorks: [
      'Send a photo, a drawing, or describe the piece',
      'I send a number and we settle the design',
