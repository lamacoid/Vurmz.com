...
export const aboutContent = {
  ...
  storyParagraphs: [
    `I started VURMZ because I wanted to build something with my hands. Laser engraving lets me take a blank piece of metal, wood, or glass and turn it into something personal — something that lasts. Every mark is permanent. That matters to me.`,
    `There's no team, no warehouse, no call center. When you text ${siteInfo.phone}, you're texting the person who's going to engrave your order, drive it to your door, and hand it to you. That's how I want it.`,
