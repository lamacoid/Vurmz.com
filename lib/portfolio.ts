...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    story: 'A heavy cleaver engraved with the chef\'s name. Knife steel varies — some take engraving easily, some need deep marking to show through finishes. We always test on the spine before touching the bevel. If you run a kitchen, we can do crew pickups: drop a stack of knives, get them back the next day.',
  },
  {
