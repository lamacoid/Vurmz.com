    ...
    <div>
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-8">
            ...
            <div>
              ...
              <p className="text-[var(--ink-soft)] leading-relaxed">
                ...
                <a href="https://squareup.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-[var(--eyebrow)] hover:text-[var(--ink)] transition-colors">
            ...
            <div>
              ...
              <div className="mt-3 space-y-1 text-[var(--ink-soft)]">
                <p>{siteInfo.founder.name}</p>
                <p>{siteInfo.legalName}</p>
                <p>{siteInfo.city}, {siteInfo.state}</p>
                <p>
                  <a href={`mailto:${siteInfo.email}`} className="text-[var(--eyebrow)] hover:text-[var(--ink)] transition-colors">
                    {siteInfo.email}
                  </a>
                </p>
                <p>
                  <a href={`sms:${siteInfo.phone.replace(/[^0-9]/g, '')}`} className="text-[var(--eyebrow)] hover:text-[var(--ink)] transition-colors">
                    {siteInfo.phone} (text)
                  </a>
                </p>
              </div>
      ...
      <section className="bg-[var(--page)] py-8 border-t border-[var(--hairline)]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Link
            href="/"
            className="text-[var(--ink-soft)] hover:text-[var(--ink)] text-sm transition-colors"
          >
            &larr; Back to VURMZ
          </Link>
        </div>
