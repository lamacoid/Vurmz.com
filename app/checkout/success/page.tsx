...
function Inner() {
  ...
  return (
    <div className="max-w-xl mx-auto px-6 py-20 text-center">
      ...
      <h1 className="text-3xl font-bold text-[#1A4F48] mb-2">Order placed</h1>
      {number && <p className="text-sm text-[#6B6259] mb-2">Order <span className="font-mono text-[#1A4F48]">{number}</span></p>}
