...
// ─────────────────────────────────────────────────────────────────────────────
// PREVIEW of the proposed single-page homepage (replaces the split chooser).
// One scroll: shop first, then an anchored "For businesses" half. Normal
// scrolling, no hijacking — the "jump" CTA is a plain anchor link.
// Not linked from anywhere and noindexed. Approve it and it becomes "/".
// ─────────────────────────────────────────────────────────────────────────────
