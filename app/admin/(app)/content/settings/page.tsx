  ...
  return (
    <div>
      <div className="flex flex-wrap gap-2 mb-3">
        {value.map(a => (
          <span key={a} className="bg-[#1a2f2e] border border-white/5 rounded-full pl-3 pr-1 py-1 text-xs text-cream flex items-center gap-2">
            {a}
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 bg-[#1a2f2e] border border-white/5 rounded-md px-3 py-2 text-sm text-cream outline-none focus:border-[#6BB8B2]"
        />
        <button
