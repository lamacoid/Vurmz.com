      ...
      <div className="space-y-5">
        ...
        <div className="bg-[#243B39] border border-white/5 rounded-xl p-5">
              ...
              <div key={i} className="grid grid-cols-[1fr_70px_100px_32px] gap-2 items-center">
                ...
                <div className="flex items-center bg-[#1a2f2e] border border-white/5 rounded-md focus-within:border-[#6BB8B2]">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent px-2 py-2 text-sm text-cream outline-none"
                  />
                </div>
                <button
          ...
          <button
            ...
            className="mt-3 text-xs text-[#6BB8B2] hover:underline"
          >
            + Add line
          </button>
          <div className="border-t border-white/5 mt-4 pt-3 text-right">
            <p className="text-[11px] uppercase tracking-wider text-gray-500">Subtotal</p>
        ...
        <div className="bg-[#243B39] border border-white/5 rounded-xl p-5">
          ...
          <div className="mt-4">
            <p className="text-[11px] uppercase tracking-wider text-gray-500 mb-1 font-semibold">Notes (optional)</p>
            <textarea
              value={notes}
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => save(false)}
            disabled={saving}
            className="px-4 h-9 bg-white/5 hover:bg-white/10 text-cream text-sm font-semibold rounded-md border border-white/10"
          >
