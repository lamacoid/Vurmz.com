      ...
      <div className="px-4 py-6 max-w-lg mx-auto">
        ...
        <div className="bg-[#16525C] rounded-xl p-4 border border-white/5 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {selected.email && (
              <a href={`mailto:${selected.email}`} className="text-xs bg-[#1d474e] px-2.5 py-1 rounded-full text-[#7FCFD4]">
                {selected.email}
              </a>
            )}
            {selected.phone && (
              <a href={`sms:${selected.phone}`} className="text-xs bg-[#1d474e] px-2.5 py-1 rounded-full text-[#7FCFD4]">
                {selected.phone}
              </a>
            )}
          </div>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0 flex-1">
                  ...
                  {msg.productInterest && (
                    <p className="text-[10px] text-[#7FCFD4] mt-0.5">{msg.productInterest}</p>
                  )}
