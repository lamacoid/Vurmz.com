    ...
    <div className="p-6 sm:p-8 max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="bg-[#16525C] border border-white/5 rounded-xl p-10 text-center text-gray-400 text-sm">
          No products yet. <Link href="/admin/products/new" className="text-[#7FCFD4] hover:underline">Add a product →</Link>
        </div>
      ) : (
        <>
          ...
          {untracked.length > 0 && (
            <div className="mt-6 bg-[#16525C] border border-white/5 rounded-xl p-5">
              ...
              <div className="flex flex-wrap gap-2">
                {untracked.map(p => (
                  <button
                    ...
                    className="text-xs bg-[#143E38] hover:bg-[#143E38]/80 border border-white/5 hover:border-[#7FCFD4]/40 rounded-full px-3 py-1 text-cream"
                  >
                    + {p.name}
                  </button>
                ))}
