...
export default function NewServiceJobPage() {
  ...
  return (
    <div className="p-6 sm:p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-[#243B39] border border-white/5 rounded-xl p-5 space-y-4">
        <div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-[#1a2f2e] border border-white/5 rounded-md px-3 py-2 text-sm text-cream outline-none"
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select value={priority} onChange={e => setPriority(parseInt(e.target.value, 10))} className="w-full bg-[#1a2f2e] border border-white/5 rounded-md px-3 py-2 text-sm text-cream outline-none">
          ...
          <div>
            ...
            <input type="date" value={dueDate} onChange={e => setDueDate(e.target.value)} className="w-full bg-[#1a2f2e] border border-white/5 rounded-md px-3 py-2 text-sm text-cream outline-none focus:border-[#6BB8B2]" />
          </div>
        </div>
        <div>
          <label className="text-[11px] uppercase tracking-wider text-gray-500 block mb-1 font-semibold">Notes</label>
          <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={4} className="w-full bg-[#1a2f2e] border border-white/5 rounded-md px-3 py-2 text-sm text-cream outline-none focus:border-[#6BB8B2]" placeholder="Details, specs, production notes…" />
        </div>
