    ...
    <div className="min-h-screen bg-[#1a2f2e]">
      ...
      <section className="pt-24 sm:pt-28 pb-8 sm:pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xs font-mono text-vurmz-teal tracking-[0.25em] uppercase mb-4">Who We Are</p>
          <h1 className="text-3xl sm:text-5xl font-bold text-cream tracking-tight leading-tight">About VURMZ</h1>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-cream tracking-tight leading-tight mb-6">
                ...
                <span className="text-gray-500">{aboutContent.subhead}</span>
              </h2>
              {aboutContent.storyParagraphs.map((p, i) => (
                <p key={i} className="text-gray-400 text-base leading-relaxed mb-4">{p}</p>
              ))}
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 bg-white/[0.015]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-mono text-vurmz-teal tracking-[0.2em] uppercase mb-4">What We Stand For</p>
          <h2 className="text-2xl sm:text-3xl font-bold text-cream tracking-tight mb-10">Built on three things.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {aboutContent.values.map((v) => (
              <div key={v.title} className="bg-white/[0.03] border border-white/[0.06] rounded-sm p-6">
                <h3 className="text-lg font-bold text-cream mb-2">{v.title}</h3>
      ...
      <section className="py-12 sm:py-16 border-t border-white/10">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/shop" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#B16558] text-white font-semibold text-sm rounded-sm hover:bg-[#954E44] transition-all">
              Browse the Shop
              <ArrowRightIcon className="w-4 h-4" />
            </Link>
            <Link href="/services/contact" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-vurmz-teal text-white font-semibold text-sm rounded-sm hover:bg-[#4A9D97] transition-all">
              Get a Quote
              <ArrowRightIcon className="w-4 h-4" />
            </Link>
          </div>
          <a href={getSmsLink()} className="inline-block mt-4 text-gray-500 hover:text-cream transition-colors text-sm">
