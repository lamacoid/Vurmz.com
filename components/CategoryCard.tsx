...
export default function CategoryCard({ category: cat, compact }: CategoryCardProps) {
  ...
  if (compact) {
    return (
      <Link
        href={`/shop/${cat.slug}`}
        className="group block bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-sm overflow-hidden hover:border-[#D96C5C]/40 transition-all duration-300"
      >
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white/[0.04] backdrop-blur-xl border border-white/10 rounded-sm overflow-hidden hover:border-[#D96C5C]/40 hover:bg-white/[0.06] transition-all duration-300"
    >
      ...
      <div className="p-5">
        ...
        {cat.serviceLink && (
          <Link
            ...
            className="inline-flex items-center gap-1 text-xs text-[#7FCFD4] font-mono tracking-wide hover:text-[#E7DFCB] transition-colors mb-4"
          >
        ...
        <div className="flex items-center justify-between">
          <div>
            <span className="text-[#D96C5C] font-bold text-sm">{price}</span>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 text-xs text-[#D96C5C] font-semibold px-3 py-1.5 border border-[#D96C5C]/30 rounded-sm hover:bg-[#D96C5C]/10 transition-colors"
            >
