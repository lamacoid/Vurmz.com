  ...
  return (
    <div className="mb-5 rounded-sm border border-white/10 bg-white/[0.03] p-4">
      ...
      <input
        ...
        className="w-full bg-white/[0.06] border border-white/15 rounded-sm px-3 py-2.5 text-sm text-[#F0E6D3] placeholder:text-gray-500 outline-none focus:border-[#D96C5C]"
      />
      ...
      <label className="block mt-3">
        ...
        <select
          ...
          className="w-full bg-white/[0.06] border border-white/15 rounded-sm px-3 py-2.5 text-sm text-[#F0E6D3] outline-none focus:border-[#D96C5C]"
        >
      ...
      <p className="mt-3 text-[11px] text-[#2FE6C4]">
