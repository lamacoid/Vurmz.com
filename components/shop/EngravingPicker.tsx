'use client'
/**
 * EngravingPicker — lets a customer add personalization (text + font) to a
 * product before adding it to the cart. Reads the curated font catalog from
 * lib/fonts.ts and live-previews the text in the selected face (the @font-face
 * declarations in app/fonts.css are loaded globally, so previews are real).
 */
