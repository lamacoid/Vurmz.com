    ...
    <div>
      ...
      {props.oneOff ? (
        <button
          ...
          className="w-full sm:w-auto inline-flex items-center justify-center px-6 h-11 bg-[#E95C4E] hover:bg-[#D24A3D] disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-sm transition-colors"
        >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            onClick={onAdd}
            className="flex-1 inline-flex items-center justify-center px-6 h-11 bg-[#E95C4E] hover:bg-[#D24A3D] text-white text-sm font-semibold rounded-sm transition-colors"
          >
