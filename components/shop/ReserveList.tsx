...
export function CategoryCard({ cat, compact = false, index = 0 }: { cat: ReserveCategory; compact?: boolean; index?: number }) {
  ...
  return (
    ...
    >
      {/* The drawing, on the glass. It brightens and lifts a hair on hover, like a light coming on. */}
      <div className={`relative ${compact ? 'aspect-[16/9]' : 'aspect-[4/3]'} flex items-center justify-center`}>
