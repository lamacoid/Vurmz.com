      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {heading && (
          <motion.h1
            ...
            className="text-[var(--hero-ink)] font-semibold text-[length:var(--step-panel)] mb-4"
          >
            {heading}
          </motion.h1>
        )}
        ...
        <Tagline
          ...
          className="text-[var(--hero-ink)] font-semibold leading-[1.08] text-[length:var(--step-section)] sm:text-[length:var(--step-display)]"
